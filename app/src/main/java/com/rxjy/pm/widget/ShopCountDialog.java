...
public class ShopCountDialog extends Dialog {

    public interface OnYesOnClickListener {

        void onYes(double count, ShopCartInfo.ShopCart.Merchant.Mat data);
    ...
    private ShopCartInfo.ShopCart.Merchant.Mat data;

    private Context mContext;

    public ShopCountDialog(@NonNull Context context) {
    ...
    public void setCount(double count, ShopCartInfo.ShopCart.Merchant.Mat data) {
        this.count = count;
        this.data = data;
