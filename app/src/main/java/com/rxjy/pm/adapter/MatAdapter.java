...
public class MatAdapter extends SingleBaseAdapter<MatInfo.Mat, MatAdapter.ViewHolder> {

    private MatContract.View mListener;

    public MatAdapter(Context context, MatContract.View mListener, List<MatInfo.Mat> datas) {
        super(context, datas);
