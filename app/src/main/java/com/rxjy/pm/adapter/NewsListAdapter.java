 ...
 */
public class NewsListAdapter extends SingleBaseAdapter<NewsListInfo.BodyBean.ListBean, NewsListAdapter.ViewHolder> {



    public NewsListAdapter(Context context, List<NewsListInfo.BodyBean.ListBean> datas) {
        super(context, datas);
    }
