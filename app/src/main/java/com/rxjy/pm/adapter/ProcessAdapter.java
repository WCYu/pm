...
public class ProcessAdapter extends BaseExpandableListAdapter {
    ...
    private List<ProcessInfo.ProcessGroup> dataList;
    private Context context;

    public ProcessAdapter(Context context, List<ProcessInfo.ProcessGroup> dataList) {
    ...
    public View getGroupView(int groupPosition, boolean b, View convertView, ViewGroup viewGroup) {
        ...
        ProcessInfo.ProcessGroup info = dataList.get(groupPosition);
        ...
        if (convertView == null) {
            ...
            holder.tvCount = (TextView) convertView.findViewById(R.id.tv_list_item_process_group_count);
        ...
        if (info.getStatus() == 0) {
            holder.tvStatus.setText("未完成"+info.getNoCount());
    ...
    public View getChildView(int groupPosition, int childPosition, boolean b, View convertView, ViewGroup viewGroup) {
        ...
        ProcessInfo.ProcessGroup.ProcessChild info = dataList.get(groupPosition).getList().get(childPosition);
        ...
        if (info.getStatus() == 0) {
            ...
            holder.tvStatus.setText(info.getNoCount()+"");
            holder.tvStatus.setTextColor(context.getResources().getColor(R.color.colorRedLight));
        } else {
