...
public class ProMoneyDetailAdapter extends SingleBaseAdapter<ProMoneyDetailInfo.ProMoneyDetail.ProMoney, ProMoneyDetailAdapter.ViewHolder> {

    public ProMoneyDetailAdapter(Context context, List<ProMoneyDetailInfo.ProMoneyDetail.ProMoney> datas) {
        super(context, datas);
    }
    ...
    @Override
    public void onBindView(int position, ProMoneyDetailInfo.ProMoneyDetail.ProMoney data, ViewHolder holder) {
...
//        }
        holder.tvType.setText(data.getMoneytype());
        holder.tvStatus.setText(data.getMoneystate());
