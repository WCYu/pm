...
public class ProcessDetailInfo {
    ...
    public static class ProcessDetail {
        ...
        private List<String> PhotoUrlForCarmea;

        public List<String> getPhotoUrlForCarmea() {
            return PhotoUrlForCarmea;
        }

        public void setPhotoUrlForCarmea(List<String> photoUrlForCarmea) {
            PhotoUrlForCarmea = photoUrlForCarmea;
        }
