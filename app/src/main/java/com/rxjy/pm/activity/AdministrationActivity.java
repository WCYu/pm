...
public class AdministrationActivity extends BaseActivity<AgreementPresenter> implements AgreementContract.View {
    @Bind(R.id.iv_back)
    ImageView ivBack;
    @Bind(R.id.tv_title)
    TextView tvTitle;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_back:
                ...
                break;
            case R.id.btn_quit:
                if(btnQuit.getText().toString().equals("同意并确认接单")) {
