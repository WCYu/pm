...
public class SaoMiaoActivity {
     ...
     */
    public SaoMiaoActivity(Activity activity) {
     ...
     */
    public SaoMiaoActivity setCaptureActivity(Class<?> captureActivity) {
     ...
     *                 of an {@link Activity}
     */
    public static SaoMiaoActivity forSupportFragment(android.support.v4.app.Fragment fragment) {
        SaoMiaoActivity integrator = new SaoMiaoActivity(fragment.getActivity());
    ...
    public static SaoMiaoActivity forFragment(Fragment fragment) {
        SaoMiaoActivity integrator = new SaoMiaoActivity(fragment.getActivity());
    ...
    public final SaoMiaoActivity addExtra(String key, Object value) {
     ...
     */
    public final SaoMiaoActivity setPrompt(String prompt) {
        if (prompt != null) {
     ...
     */
    public SaoMiaoActivity setOrientationLocked(boolean locked) {
     ...
     * @return this
     */
    public SaoMiaoActivity setCameraId(int cameraId) {
        if (cameraId >= 0) {
     ...
     * @return this
     */
    public SaoMiaoActivity setBeepEnabled(boolean enabled) {
     ...
     * @return this
     */
    public SaoMiaoActivity setBarcodeImageEnabled(boolean enabled) {
     ...
     * @return this
     */
    public SaoMiaoActivity setDesiredBarcodeFormats(Collection<String> desiredBarcodeFormats) {
     ...
     */
    public SaoMiaoActivity setTimeout(long timeout) {
